...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.content_en'
        db.add_column(u'projects_project', 'content_en',
                      self.gf('mezzanine.core.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.content_fr'
        db.add_column(u'projects_project', 'content_fr',
                      self.gf('mezzanine.core.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.content_ru'
        db.add_column(u'projects_project', 'content_ru',
                      self.gf('mezzanine.core.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.content_en'
        db.delete_column(u'projects_project', 'content_en')

        # Deleting field 'Project.content_fr'
        db.delete_column(u'projects_project', 'content_fr')

        # Deleting field 'Project.content_ru'
        db.delete_column(u'projects_project', 'content_ru')
