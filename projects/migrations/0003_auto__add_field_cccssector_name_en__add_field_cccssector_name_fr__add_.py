...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CCCSSector.name_en'
        db.add_column(u'projects_cccssector', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=512, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CCCSSector.name_fr'
        db.add_column(u'projects_cccssector', 'name_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=512, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CCCSSector.name_ru'
        db.add_column(u'projects_cccssector', 'name_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=512, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CCCSSector.plural_name_en'
        db.add_column(u'projects_cccssector', 'plural_name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CCCSSector.plural_name_fr'
        db.add_column(u'projects_cccssector', 'plural_name_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CCCSSector.plural_name_ru'
        db.add_column(u'projects_cccssector', 'plural_name_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'IFCTheme.name_en'
        db.add_column(u'projects_ifctheme', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=512, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'IFCTheme.name_fr'
        db.add_column(u'projects_ifctheme', 'name_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=512, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'IFCTheme.name_ru'
        db.add_column(u'projects_ifctheme', 'name_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=512, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'IFCTheme.plural_name_en'
        db.add_column(u'projects_ifctheme', 'plural_name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'IFCTheme.plural_name_fr'
        db.add_column(u'projects_ifctheme', 'plural_name_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'IFCTheme.plural_name_ru'
        db.add_column(u'projects_ifctheme', 'plural_name_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'IFCSector.name_en'
        db.add_column(u'projects_ifcsector', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=512, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'IFCSector.name_fr'
        db.add_column(u'projects_ifcsector', 'name_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=512, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'IFCSector.name_ru'
        db.add_column(u'projects_ifcsector', 'name_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=512, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'IFCSector.plural_name_en'
        db.add_column(u'projects_ifcsector', 'plural_name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'IFCSector.plural_name_fr'
        db.add_column(u'projects_ifcsector', 'plural_name_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'IFCSector.plural_name_ru'
        db.add_column(u'projects_ifcsector', 'plural_name_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CCCSTheme.name_en'
        db.add_column(u'projects_cccstheme', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=512, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CCCSTheme.name_fr'
        db.add_column(u'projects_cccstheme', 'name_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=512, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CCCSTheme.name_ru'
        db.add_column(u'projects_cccstheme', 'name_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=512, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CCCSTheme.plural_name_en'
        db.add_column(u'projects_cccstheme', 'plural_name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CCCSTheme.plural_name_fr'
        db.add_column(u'projects_cccstheme', 'plural_name_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CCCSTheme.plural_name_ru'
        db.add_column(u'projects_cccstheme', 'plural_name_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CCCSSector.name_en'
        db.delete_column(u'projects_cccssector', 'name_en')

        # Deleting field 'CCCSSector.name_fr'
        db.delete_column(u'projects_cccssector', 'name_fr')

        # Deleting field 'CCCSSector.name_ru'
        db.delete_column(u'projects_cccssector', 'name_ru')

        # Deleting field 'CCCSSector.plural_name_en'
        db.delete_column(u'projects_cccssector', 'plural_name_en')

        # Deleting field 'CCCSSector.plural_name_fr'
        db.delete_column(u'projects_cccssector', 'plural_name_fr')

        # Deleting field 'CCCSSector.plural_name_ru'
        db.delete_column(u'projects_cccssector', 'plural_name_ru')

        # Deleting field 'IFCTheme.name_en'
        db.delete_column(u'projects_ifctheme', 'name_en')

        # Deleting field 'IFCTheme.name_fr'
        db.delete_column(u'projects_ifctheme', 'name_fr')

        # Deleting field 'IFCTheme.name_ru'
        db.delete_column(u'projects_ifctheme', 'name_ru')

        # Deleting field 'IFCTheme.plural_name_en'
        db.delete_column(u'projects_ifctheme', 'plural_name_en')

        # Deleting field 'IFCTheme.plural_name_fr'
        db.delete_column(u'projects_ifctheme', 'plural_name_fr')

        # Deleting field 'IFCTheme.plural_name_ru'
        db.delete_column(u'projects_ifctheme', 'plural_name_ru')

        # Deleting field 'IFCSector.name_en'
        db.delete_column(u'projects_ifcsector', 'name_en')

        # Deleting field 'IFCSector.name_fr'
        db.delete_column(u'projects_ifcsector', 'name_fr')

        # Deleting field 'IFCSector.name_ru'
        db.delete_column(u'projects_ifcsector', 'name_ru')

        # Deleting field 'IFCSector.plural_name_en'
        db.delete_column(u'projects_ifcsector', 'plural_name_en')

        # Deleting field 'IFCSector.plural_name_fr'
        db.delete_column(u'projects_ifcsector', 'plural_name_fr')

        # Deleting field 'IFCSector.plural_name_ru'
        db.delete_column(u'projects_ifcsector', 'plural_name_ru')

        # Deleting field 'CCCSTheme.name_en'
        db.delete_column(u'projects_cccstheme', 'name_en')

        # Deleting field 'CCCSTheme.name_fr'
        db.delete_column(u'projects_cccstheme', 'name_fr')

        # Deleting field 'CCCSTheme.name_ru'
        db.delete_column(u'projects_cccstheme', 'name_ru')

        # Deleting field 'CCCSTheme.plural_name_en'
        db.delete_column(u'projects_cccstheme', 'plural_name_en')

        # Deleting field 'CCCSTheme.plural_name_fr'
        db.delete_column(u'projects_cccstheme', 'plural_name_fr')

        # Deleting field 'CCCSTheme.plural_name_ru'
        db.delete_column(u'projects_cccstheme', 'plural_name_ru')
