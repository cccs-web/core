...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CCCSSector.abbreviation'
        db.add_column(u'projects_cccssector', 'abbreviation',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=18),
                      keep_default=False)

        # Adding field 'IFCTheme.abbreviation'
        db.add_column(u'projects_ifctheme', 'abbreviation',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=18),
                      keep_default=False)

        # Adding field 'CCCSTheme.abbreviation'
        db.add_column(u'projects_cccstheme', 'abbreviation',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=18),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CCCSSector.abbreviation'
        db.delete_column(u'projects_cccssector', 'abbreviation')

        # Deleting field 'IFCTheme.abbreviation'
        db.delete_column(u'projects_ifctheme', 'abbreviation')

        # Deleting field 'CCCSTheme.abbreviation'
        db.delete_column(u'projects_cccstheme', 'abbreviation')
