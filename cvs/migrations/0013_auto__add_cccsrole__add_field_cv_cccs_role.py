...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CCCSRole'
        db.create_table(u'cvs_cccsrole', (
        ...
        db.send_create_signal(u'cvs', ['CCCSRole'])

        # Adding field 'CV.cccs_role'
        db.add_column(u'cvs_cv', 'cccs_role',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cvs.CCCSRole'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CCCSRole'
        db.delete_table(u'cvs_cccsrole')

        # Deleting field 'CV.cccs_role'
        db.delete_column(u'cvs_cv', 'cccs_role_id')
