...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'cvs_associaterole', (
            ('name_ru', self.gf('django.db.models.fields.CharField')(unique=True, max_length=512, null=True, blank=True)),
            ('plural_name_en', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('name_fr', self.gf('django.db.models.fields.CharField')(unique=True, max_length=512, null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=512, unique=True)),
            ('plural_name_fr', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('name_en', self.gf('django.db.models.fields.CharField')(unique=True, max_length=512, null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('plural_name_ru', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
        ...
        # Deleting field 'CCCSRole.name_en'
        db.delete_column(u'cvs_cccsrole', 'name_en')

        # Deleting field 'CCCSRole.name_fr'
        db.delete_column(u'cvs_cccsrole', 'name_fr')

        # Deleting field 'CCCSRole.name_ru'
        db.delete_column(u'cvs_cccsrole', 'name_ru')

        # Deleting field 'CCCSRole.plural_name_en'
        db.delete_column(u'cvs_cccsrole', 'plural_name_en')

        # Deleting field 'CCCSRole.plural_name_fr'
        db.delete_column(u'cvs_cccsrole', 'plural_name_fr')

        # Deleting field 'CCCSRole.plural_name_ru'
        db.delete_column(u'cvs_cccsrole', 'plural_name_ru')
    ...
    models = {
        ...
        u'cvs.cccsrole': {
            'Meta': {'ordering': "['name']", 'object_name': 'CCCSRole'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'cvs.cv': {
            ...
            'cccs_role': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cvs.CCCSRole']", 'null': 'True', 'blank': 'True'}),
        ...
        u'cvs.cveducation': {
            ...
            'minors': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
        ...
        u'cvs.cvemployment': {
            ...
            'accomplishments': ('mezzanine.core.fields.RichTextField', [], {'null': 'True', 'blank': 'True'}),
            'cv': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cvs.CV']"}),
        ...
        u'cvs.cvproject': {
            ...
            'activities': ('mezzanine.core.fields.RichTextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'references': ('mezzanine.core.fields.RichTextField', [], {'null': 'True', 'blank': 'True'}),
