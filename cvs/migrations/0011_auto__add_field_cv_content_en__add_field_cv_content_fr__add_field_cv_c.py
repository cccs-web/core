...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CV.content_en'
        db.add_column(u'cvs_cv', 'content_en',
                      self.gf('mezzanine.core.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CV.content_fr'
        db.add_column(u'cvs_cv', 'content_fr',
                      self.gf('mezzanine.core.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CV.content_ru'
        db.add_column(u'cvs_cv', 'content_ru',
                      self.gf('mezzanine.core.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CV.content_en'
        db.delete_column(u'cvs_cv', 'content_en')

        # Deleting field 'CV.content_fr'
        db.delete_column(u'cvs_cv', 'content_fr')

        # Deleting field 'CV.content_ru'
        db.delete_column(u'cvs_cv', 'content_ru')
