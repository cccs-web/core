...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CVProject.service_on_site'
        db.add_column(u'cvs_cvproject', 'service_on_site',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CVProject.service_off_site'
        db.add_column(u'cvs_cvproject', 'service_off_site',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CVProject.service_remote'
        db.add_column(u'cvs_cvproject', 'service_remote',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CVProject.client_end'
        db.add_column(u'cvs_cvproject', 'client_end',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CVProject.client_contract'
        db.add_column(u'cvs_cvproject', 'client_contract',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CVProject.client_beneficiary'
        db.add_column(u'cvs_cvproject', 'client_beneficiary',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CVProject.contract'
        db.add_column(u'cvs_cvproject', 'contract',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CVProject.service_on_site'
        db.delete_column(u'cvs_cvproject', 'service_on_site')

        # Deleting field 'CVProject.service_off_site'
        db.delete_column(u'cvs_cvproject', 'service_off_site')

        # Deleting field 'CVProject.service_remote'
        db.delete_column(u'cvs_cvproject', 'service_remote')

        # Deleting field 'CVProject.client_end'
        db.delete_column(u'cvs_cvproject', 'client_end')

        # Deleting field 'CVProject.client_contract'
        db.delete_column(u'cvs_cvproject', 'client_contract')

        # Deleting field 'CVProject.client_beneficiary'
        db.delete_column(u'cvs_cvproject', 'client_beneficiary')

        # Deleting field 'CVProject.contract'
        db.delete_column(u'cvs_cvproject', 'contract')
