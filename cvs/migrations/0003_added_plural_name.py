...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssociateRole.plural_name'
        db.add_column(u'cvs_associaterole', 'plural_name',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Language.plural_name'
        db.add_column(u'cvs_language', 'plural_name',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AssociateRole.plural_name'
        db.delete_column(u'cvs_associaterole', 'plural_name')

        # Deleting field 'Language.plural_name'
        db.delete_column(u'cvs_language', 'plural_name')
