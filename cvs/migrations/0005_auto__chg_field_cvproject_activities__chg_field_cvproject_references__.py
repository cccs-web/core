...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CVProject.activities'
        db.alter_column(u'cvs_cvproject', 'activities', self.gf('mezzanine.core.fields.RichTextField')(null=True))

        # Changing field 'CVProject.references'
        db.alter_column(u'cvs_cvproject', 'references', self.gf('mezzanine.core.fields.RichTextField')(null=True))
        # Adding field 'CV.content'
        db.add_column(u'cvs_cv', 'content',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CVProject.activities'
        db.alter_column(u'cvs_cvproject', 'activities', self.gf('django.db.models.fields.TextField')(max_length=4096, null=True))

        # Changing field 'CVProject.references'
        db.alter_column(u'cvs_cvproject', 'references', self.gf('django.db.models.fields.TextField')(max_length=512, null=True))
        # Deleting field 'CV.content'
        db.delete_column(u'cvs_cv', 'content')
