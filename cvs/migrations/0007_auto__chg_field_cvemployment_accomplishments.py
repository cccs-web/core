...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CVEmployment.accomplishments'
        db.alter_column(u'cvs_cvemployment', 'accomplishments', self.gf('mezzanine.core.fields.RichTextField')(null=True))

    def backwards(self, orm):

        # Changing field 'CVEmployment.accomplishments'
        db.alter_column(u'cvs_cvemployment', 'accomplishments', self.gf('django.db.models.fields.TextField')(max_length=8192, null=True))
