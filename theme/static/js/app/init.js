...
requirejs.config({
    ...
    , paths : {
        ...
        // Foundation 5.3.3
        , 'foundation.core':            ['http://cdnjs.cloudflare.com/ajax/libs/foundation/5.3.3/js/foundation/foundation.min','libs/foundation/components/foundation']
        , 'foundation.abide':           ['http://cdnjs.cloudflare.com/ajax/libs/foundation/5.3.3/js/foundation/foundation.abide.min','libs/foundation/foundation.abide']
        , 'foundation.accordion':       ['http://cdnjs.cloudflare.com/ajax/libs/foundation/5.3.3/js/foundation/foundation.accordion.min','libs/foundation/foundation.accordion']
        , 'foundation.alert':           ['http://cdnjs.cloudflare.com/ajax/libs/foundation/5.3.3/js/foundation/foundation.alert.min','libs/foundation/foundation.alert']
        , 'foundation.clearing':        ['http://cdnjs.cloudflare.com/ajax/libs/foundation/5.3.3/js/foundation/foundation.clearing.min','libs/foundation/foundation.clearing']
        , 'foundation.dropdown':        ['http://cdnjs.cloudflare.com/ajax/libs/foundation/5.3.3/js/foundation/foundation.dropdown.min','libs/foundation/foundation.dropdown']
        , 'foundation.equalizer':       ['http://cdnjs.cloudflare.com/ajax/libs/foundation/5.3.3/js/foundation/foundation.equalizer.min','libs/foundation/foundation.equalizer']
        , 'foundation.interchange':     ['http://cdnjs.cloudflare.com/ajax/libs/foundation/5.3.3/js/foundation/foundation.interchange.min','libs/foundation/foundation.interchange']
        , 'foundation.joyride':         ['http://cdnjs.cloudflare.com/ajax/libs/foundation/5.3.3/js/foundation/foundation.joyride.min','libs/foundation/foundation.joyride']
        , 'foundation.magellan':        ['http://cdnjs.cloudflare.com/ajax/libs/foundation/5.3.3/js/foundation/foundation.magellan.min','libs/foundation/foundation.magellan']
        , 'foundation.offcanvas':       ['http://cdnjs.cloudflare.com/ajax/libs/foundation/5.3.3/js/foundation/foundation.offcanvas.min','libs/foundation/foundation.offcanvas']
        , 'foundation.orbit':           ['http://cdnjs.cloudflare.com/ajax/libs/foundation/5.3.3/js/foundation/foundation.orbit.min','libs/foundation/foundation.orbit']
        , 'foundation.reveal':          ['http://cdnjs.cloudflare.com/ajax/libs/foundation/5.3.3/js/foundation/foundation.reveal.min','libs/foundation/foundation.reveal']
        , 'foundation.slider':          ['http://cdnjs.cloudflare.com/ajax/libs/foundation/5.3.3/js/foundation/foundation.slider.min','libs/foundation/foundation.reveal']
        , 'foundation.tab':             ['http://cdnjs.cloudflare.com/ajax/libs/foundation/5.3.3/js/foundation/foundation.tab.min','libs/foundation/foundation.tab']
        , 'foundation.tooltip':         ['http://cdnjs.cloudflare.com/ajax/libs/foundation/5.3.3/js/foundation/foundation.tooltip.min','libs/foundation/foundation.tooltip']
        , 'foundation.topbar':          ['http://cdnjs.cloudflare.com/ajax/libs/foundation/5.3.3/js/foundation/foundation.topbar.min','libs/foundation/foundation.topbar']
