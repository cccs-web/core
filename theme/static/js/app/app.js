require([
    ...
    , 'jCookie'
        ...
        $('#search').click(function(e) {
            ...
            $('.search').slideToggle('fast').toggleClass('visible');
        });

        $(window).scroll(function() {
            if ($(this).scrollTop() <= tlh) {
                $('#search').addClass('active');
                $('.search').fadeIn('fast').addClass('visible');
                return;
            } else if ($(this).scrollTop() > tlh) {
                $('#search').removeClass('active');
                $('.search').fadeOut('fast').removeClass('visible');
                return;
            } else {
                return;
            }
        ...
        // var 
        //     mainMenu = $('<div>').append($('#navbar-1').clone()).remove().html(),
        //     tlh = -1*(toplinksh) + 'px';
        ...
        //     $('#navbar-1').removeClass('dropdown-menu').removeAttr('role'); 

        //     $('body').css('margin-top',tlh);
        //     $('#navbar-1').append('<li><a><span id="toggle-topbar"></span></a></li>');
